          ...
          {navLinks.map((item, index) => (
            <Link key={index} href={item.href}>
              <div className="group flex items-center gap-2">
                ...
                <h1 className="z-10 -translate-x-6 cursor-pointer font-mono text-xl font-medium text-black transition-transform duration-300 ease-out group-hover:translate-x-0 group-hover:text-blue-500 dark:text-white md:-translate-x-12 md:text-4xl md:group-hover:translate-x-0">
                  {item?.label}
                </h1>
              </div>
            </Link>
